...
// 
//
// Related Topics 哈希表 链表 双指针 👍 707 👎 0
...
public:
    ...
    ListNode *getIntersectionNode(ListNode *headA, ListNode *headB) {
        int Alen = get_length(headA);
        int Blen = get_length(headB);
        ListNode *slow = Alen < Blen ? headA : headB;
        ListNode *fast = Alen < Blen ? headB : headA;
